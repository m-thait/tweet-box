...
describe("TreeSelect Hooks", () => {
  ...
  it("should return tree select event handlers", () => {
    ...
    expect(typeof handleChipClick).toBe("function");
    ...
    expect(typeof handleBlanksChange).toBe("function");
  ...
  describe("handleChipClick", () => {
    it("should open dropdown on chip click", () => {
      const { handlers } = init({});

      act(() => {
        handlers.current.handleChipClick();
      });
  ...
  describe("handleBlanksChange", () => {
    it("should call onChange callback with null", () => {
      const { handlers } = init({});

      act(() => {
        handlers.current.handleBlanksChange(
          {} as React.ChangeEvent<HTMLInputElement>,
          false
        );
      });
