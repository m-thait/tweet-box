  ...
  Items: [
    {
      scores: {
        L: [
          { M: { score_desc: { S: "CIS-1" }, score_id: { N: "1" } } },
          { M: { score_desc: { S: "E-1" }, score_id: { N: "2" } } },
          { M: { score_desc: { S: "S-1" }, score_id: { N: "3" } } },
          { M: { score_desc: { S: "G-1" }, score_id: { N: "4" } } },
        ],
      },
      cis_definition: {
        L: [
    ...
    },
    {
      scores: {
        L: [
          { M: { score_desc: { S: "CIS-2" }, score_id: { N: "5" } } },
          { M: { score_desc: { S: "E-2" }, score_id: { N: "6" } } },
          { M: { score_desc: { S: "S-2" }, score_id: { N: "7" } } },
          { M: { score_desc: { S: "G-2" }, score_id: { N: "8" } } },
        ],
      },
      cis_definition: {
        L: [
    ...
    },
    {
      scores: {
        L: [
          { M: { score_desc: { S: "CIS-3" }, score_id: { N: "9" } } },
          { M: { score_desc: { S: "E-3" }, score_id: { N: "10" } } },
          { M: { score_desc: { S: "S-3" }, score_id: { N: "11" } } },
          { M: { score_desc: { S: "G-3" }, score_id: { N: "12" } } },
        ],
      },
      cis_definition: {
        L: [
    ...
    },
    {
      scores: {
        L: [
          { M: { score_desc: { S: "CIS-4" }, score_id: { N: "13" } } },
          { M: { score_desc: { S: "E-4" }, score_id: { N: "14" } } },
          { M: { score_desc: { S: "S-4" }, score_id: { N: "15" } } },
          { M: { score_desc: { S: "G-4" }, score_id: { N: "16" } } },
        ],
      },
      cis_definition: {
        L: [
      ...
      ips_definition: {
        L: [
          ...
          { M: { line_id: { NULL: true }, definition: { NULL: true } } },
        ],
      },
      identifier: { N: "4" },
    },
    {
      scores: {
        L: [
          { M: { score_desc: { S: "CIS-5" }, score_id: { N: "17" } } },
          { M: { score_desc: { S: "E-5" }, score_id: { N: "18" } } },
          { M: { score_desc: { S: "S-5" }, score_id: { N: "19" } } },
          { M: { score_desc: { S: "G-5" }, score_id: { N: "20" } } },
        ],
      },
      cis_definition: {
        L: [
